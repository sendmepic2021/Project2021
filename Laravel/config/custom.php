...
return [
    'custom' => [
        ...
        'templateTitle' => 'SendMePic', //template Title can be changed, default(SendMePic)
    ...
    'mail_details' =>[
         ...
         'MAIL_PORT'=>587,
         'MAIL_USERNAME'=>'sendmepic2021@gmail.com',
         'MAIL_PASSWORD'=>'nxwkgaroseguptoo',
         'MAIL_ENCRYPTION'=>'tls',
         'MAIL_FROM_ADDRESS'=>'sendmepic2021@gmail.com',
         'MAIL_FROM_NAME'=>"Softqubes",
    ]
];
