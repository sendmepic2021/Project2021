        ...
        <ul class="nav nav-tabs mb-2" role="tablist">
          <li class="nav-item">
              <span class="nav-link d-flex align-items-center active" id="account-tab" data-toggle="tab"
                  ...
                  <i class="bx bx-user mr-25"></i><span class="d-none d-sm-block">Profile</span>
              </span>
          </li>
                        ...
                        <div class="form-group">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="first_name" placeholder="firstname"
                                    ...
                                    data-validation-required-message="This first_name field is required">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="controls">
                                <label>Mobile</label>
                                <input type="number" class="form-control" name="mobile" placeholder="number"
                                    value="{{$user->mobile}}" required minlength="7" onkeypress="if(this.value.length==13) return false;"
                        ...
                        <div class="form-group">
                            <div class="controls">
                                ...
                                <input type="text" class="form-control" name="last_name" placeholder="lastname"
                                    ...
                                    data-validation-required-message="This last_name field is required">
                            </div>
                        </div>
