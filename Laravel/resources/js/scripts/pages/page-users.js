...
$(document).ready(function () {
    ...
    $("#users-list-devicetype").on("change", function () {
        var usersdevicetypeSelect = $("#users-list-devicetype").val();
        usersTable.search(usersdevicetypeSelect).draw();
    });
    // page users list role filter
    $("#users-list-logintype").on("change", function () {
        var userslogintypeSelect = $("#users-list-logintype").val();
        // console.log(usersRoleSelect);
        usersTable.search(userslogintypeSelect).draw();
    });
    // page users list status filter
    $("#users-list-is_active").on("change", function () {
        var usersStatusSelect = $("#users-list-is_active").val();
