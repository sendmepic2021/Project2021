...
resRequestDetailEntityFromJson(ResRequestDetailEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		data.data = ResRequestDetailData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> resRequestDetailEntityToJson(ResRequestDetailEntity entity) {
...
resRequestDetailDataFromJson(ResRequestDetailData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> resRequestDetailDataToJson(ResRequestDetailData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
