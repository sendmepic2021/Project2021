...
resGetUserDetailsByLatLongEntityFromJson(ResGetUserDetailsByLatLongEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		data.data = ResGetUserDetailsByLatLongData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> resGetUserDetailsByLatLongEntityToJson(ResGetUserDetailsByLatLongEntity entity) {
...
resGetUserDetailsByLatLongDataFromJson(ResGetUserDetailsByLatLongData data, Map<String, dynamic> json) {
	if (json['user_list'] != null) {
		data.userList = (json['user_list'] as List).map((v) => ResGetUserDetailsByLatLongDataUserList().fromJson(v)).toList();
	}
	if (json['image_list'] != null) {
		data.imageList = (json['image_list'] as List).map((v) => ResGetUserDetailsByLatLongDataImageList().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> resGetUserDetailsByLatLongDataToJson(ResGetUserDetailsByLatLongData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['user_list'] =  entity.userList?.map((v) => v.toJson())?.toList();
	data['image_list'] =  entity.imageList?.map((v) => v.toJson())?.toList();
	return data;
}

resGetUserDetailsByLatLongDataUserListFromJson(ResGetUserDetailsByLatLongDataUserList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> resGetUserDetailsByLatLongDataUserListToJson(ResGetUserDetailsByLatLongDataUserList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
...
resGetUserDetailsByLatLongDataImageListFromJson(ResGetUserDetailsByLatLongDataImageList data, Map<String, dynamic> json) {
	if (json['id'] != null) {
		data.id = json['id'] is String
				? int.tryParse(json['id'])
				: json['id'].toInt();
...
Map<String, dynamic> resGetUserDetailsByLatLongDataImageListToJson(ResGetUserDetailsByLatLongDataImageList entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
