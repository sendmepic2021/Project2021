...
updateUserResEntityFromJson(UpdateUserResEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		data.data = UpdateUserResData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> updateUserResEntityToJson(UpdateUserResEntity entity) {
...
updateUserResDataFromJson(UpdateUserResData data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> updateUserResDataToJson(UpdateUserResData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
