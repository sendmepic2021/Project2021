...
getUserFromLocResEntityFromJson(GetUserFromLocResEntity data, Map<String, dynamic> json) {
	if (json['status'] != null) {
	...
	if (json['data'] != null) {
		data.data = GetUserFromLocResData().fromJson(json['data']);
	}
	return data;
}

Map<String, dynamic> getUserFromLocResEntityToJson(GetUserFromLocResEntity entity) {
...
getUserFromLocResDataFromJson(GetUserFromLocResData data, Map<String, dynamic> json) {
	if (json['image_list'] != null) {
		data.imageList = (json['image_list'] as List).map((v) => v).toList().cast<dynamic>();
	}
	if (json['user'] != null) {
		data.user = (json['user'] as List).map((v) => GetUserFromLocResDataUser().fromJson(v)).toList();
	}
	return data;
}

Map<String, dynamic> getUserFromLocResDataToJson(GetUserFromLocResData entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
...
getUserFromLocResDataUserFromJson(GetUserFromLocResDataUser data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> getUserFromLocResDataUserToJson(GetUserFromLocResDataUser entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
